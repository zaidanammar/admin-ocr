            ...
            <div className="relative w-full px-5 py-4 max-w-full">
                ...
                <div className="mt-5 flex items-center">
                    ...
                    <div>
                        ...
                        <div>
                            <h1 className="font-normal text-sm text-abuabu">Untuk melindungi keamanan akun anda, masukkan password lama anda</h1>
                        </div>
                    </div>
                </div>

                <div className="mt-7 flex">
                    <input type={type} placeholder="Masukkan password lama" className="font-normal text-sm w-full italic" onChange={handleChange} />
                ...
                <div className="mt-12 mb-3 flex justify-end">
                    <button className="bg-biru text-white py-0.5 w-2/5 rounded" onClick={checkPassword}>Lanjut</button>
                </div>
            </div>
        </div>
    );
